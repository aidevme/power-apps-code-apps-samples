// AI-CONTEXT: Batch lookup resolver hook — resolves GUIDs to display names for systemusers, accounts, and business units.
// AI-FILE-RELATIONS:
//   - generated: ../../generated/services/SystemusersService (systemuser name resolution)
//   - generated: ../../generated/services/AccountsService (account name resolution)
//   - generated: ../../generated/services/BusinessunitsService (business unit name resolution)
// AI-PATTERN: Cache unfetched GUIDs via useRef sets to avoid redundant network calls on re-render.
