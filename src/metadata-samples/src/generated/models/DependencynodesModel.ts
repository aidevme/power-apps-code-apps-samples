 ...
 */
export const Dependencynodescomponenttype = {
  1: 'Entity',
  2: 'Attribute',
  3: 'Relationship',
...
export type Dependencynodescomponenttype = keyof typeof Dependencynodescomponenttype;

export interface DependencynodesBase {
  introducedversion?: number;
  objectid: string;
}

export interface Dependencynodes extends DependencynodesBase {
  componenttype: Dependencynodescomponenttype;
  componenttypename?: string;
  dependencynodeid: string;
  issharedcomponent?: boolean;
  parentid?: string;
  versionnumber?: number;
  basesolutionid?: object;
  _basesolutionid_value?: string;
  topsolutionid?: object;
  _topsolutionid_value?: string;
}