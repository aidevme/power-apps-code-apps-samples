 ...
 */
export const Invaliddependenciesexistingcomponenttype = {
  1: 'Entity',
  2: 'Attribute',
  3: 'Relationship',
...
export type Invaliddependenciesexistingcomponenttype = keyof typeof Invaliddependenciesexistingcomponenttype;
export const Invaliddependenciesexistingdependencytype = {
  0: 'None',
  1: 'SolutionInternal',
  2: 'Published',
  4: 'Unpublished'
} as const;
export type Invaliddependenciesexistingdependencytype = keyof typeof Invaliddependenciesexistingdependencytype;
export const Invaliddependenciesmissingcomponenttype = {
  1: 'Entity',
  2: 'Attribute',
  3: 'Relationship',
  4: 'AttributePicklistValue',
...
export type Invaliddependenciesmissingcomponenttype = keyof typeof Invaliddependenciesmissingcomponenttype;

export interface Invaliddependencies {
  existingcomponentid?: string;
  existingcomponenttype?: Invaliddependenciesexistingcomponenttype;
  existingcomponenttypename?: string;
  existingdependencytype: Invaliddependenciesexistingdependencytype;
  existingdependencytypename?: string;
  ...
  missingcomponenttype: Invaliddependenciesmissingcomponenttype;
  missingcomponenttypename?: string;
}