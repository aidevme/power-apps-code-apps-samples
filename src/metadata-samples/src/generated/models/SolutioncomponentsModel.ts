 ...
 */
export const Solutioncomponentscomponenttype = {
  1: 'Entity',
  2: 'Attribute',
  3: 'Relationship',
...
export type Solutioncomponentscomponenttype = keyof typeof Solutioncomponentscomponenttype;
export const Solutioncomponentsrootcomponentbehavior = {
  0: 'IncludeSubcomponents',
  1: 'Donotincludesubcomponents',
  2: 'IncludeAsShellOnly'
} as const;
export type Solutioncomponentsrootcomponentbehavior = keyof typeof Solutioncomponentsrootcomponentbehavior;

export interface SolutioncomponentsBase {
}

export interface Solutioncomponents extends SolutioncomponentsBase {
  ...
  objectid?: string;
  rootcomponentbehavior?: Solutioncomponentsrootcomponentbehavior;
